# Madhuaravind P's Portfolio ⚡️ [![GitHub](https://img.shields.io/github/license/Madhuarvind/madhuaravind-datafolio?color=blue)](https://github.com/Madhuarvind/madhuaravind-datafolio/blob/main/LICENSE) [![GitHub stars](https://img.shields.io/github/stars/Madhuarvind/madhuaravind-datafolio)](https://github.com/Madhuarvind/madhuaravind-datafolio/stargazers)

## Personal Portfolio for Data Analyst & Full Stack Developer
...
This is my personal portfolio showcasing my skills as an aspiring Data Analyst and Full Stack Developer. Built using React.js, it highlights my projects, experience, education, and achievements in data analytics, machine learning, and web development.

Live site: [https://madhuaravind-datafolio.netlify.app](https://madhuaravind-datafolio.netlify.app) (or update with your deployed URL).

Forked from [DeveloperFolio](https://github.com/saadpasta/developerFolio) and customized for my profile.
...
## Portfolio Sections
✔️ Summary and Greeting (Hi, I'm Madhuaravind P)\
✔️ Skills (Full Stack Development & Data Analytics/ML)\
✔️ Education (MKCE, GUVI, NPTEL, etc.)\
✔️ Work Experience (IBM Cloud & AI, Pantech Learning)\
✔️ Projects (Zomato Analysis, Smartbite, InventoryPro, etc.)\
✔️ Achievements (Data Analytics, ML, Data Science Certificates)\
✔️ Contact Me\
✔️ GitHub Profile & Social Links

Live demo: [View Portfolio](https://madhuaravind-datafolio.netlify.app) (update URL as needed).
...
You'll need [Git](https://git-scm.com) and [Node.js](https://nodejs.org/en/download/) (v14+).

```
git clone https://github.com/Madhuarvind/madhuaravind-datafolio.git
cd madhuaravind-datafolio
npm install
npm start
```
...
See "Getting Started" above. Customize `src/portfolio.js` for your details.

## Linking to GitHub

For GitHub profile and repos in the portfolio, set up .env with your token:

Create .env:
```
REACT_APP_GITHUB_TOKEN=your_token
GITHUB_USERNAME=Madhuarvind
```

See GitHub docs for token creation (no scopes needed).

## Blogs

Medium blogs are disabled in this portfolio (set displayMediumBlogs: false in portfolio.js).

## Customization

All content is in `src/portfolio.js`. Update greeting, skills, experience, projects, etc.

Resume: Link in portfolio.js points to Google Drive folder for viewing (no download).

Emojis: Use `emoji("text")` in portfolio.js.

Animations: Lottie files in `src/assets/lottie/`.

Twitter: Set userName in portfolio.js (without @).

## Deployment

Deployed on Netlify: https://madhuaravind-datafolio.netlify.app (update URL).

For GitHub Pages:
- Set "homepage" in package.json to your repo (e.g., "https://Madhuarvind.github.io/madhuaravind-datafolio").
- Run `npm run deploy`.

For Netlify: Connect GitHub repo, set build command `npm run build`, publish dir `build`.

See CRA docs: https://create-react-app.dev/docs/deployment.
